                ...
                <div class="static-content-wrapper">
                    <div class="static-content">
                        <div class="page-content">
							...
							<li class="active"><a href="tables-data.html">Users</a></li>
                                          ...
                                          <thead>
                                            <tr>
                                              <!-- <th>ID</th> -->
                                                ...
                                                <th width="5%">Uptime</th>
                                                <th width="5%">Idle Time</th>
                                                <th width="8%">Byte In</th>
                                                <th width="8%">Byte Out</th>
                                          ...
                                          <tbody>
                                            <tr>
                                              <?php foreach ($active as $user) {
                                                if ($user['radius']=='false') {?>
                                                  <td></td>
                                                  <?
                                                }else{?>
                                                  <td>R</td>
                                              <? }?>
                                              <td><?echo $user['server'];?></td>
                                              <td><?echo $user['user'];?></td>
                                              <td><?echo $user['address'];?></td>
                                              <td><?echo $user['mac-address'];?></td>
                                              <td><?echo $user['uptime'];?></td>
                                              <td><?echo $user['idle-time'];?></td>
                                              <td><?echo number_format($user['bytes-in']/1024/1024,2)." MB";?></td>
                                              <td><?echo number_format($user['bytes-out']/1024/1024,2)." MB";?></td>
                                              <td></td>
                                            </tr>
                                            <? } ?>
                                          </tbody>
