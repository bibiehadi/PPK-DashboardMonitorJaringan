		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body no-padding">
					<table id="ourDevices" class="table table-striped table-bordered data" cellspacing="0" width="100%">
						<thead>
							 <tr>
				                <th>Identity</th>
				                <th>Mac-Address</th>
...
<script type="text/javascript">
		 $('#ourDevices').dataTable({
				"processing" : true,
				"severSide"  : true,
				"order" : [],
				"ajax" : {
					"url" : "<?php echo site_url('mikrotik/ourDevicesJSON') ?>",
					// "type" : "POST",
					"dataType" : "JSON"
				},
				// "columnDefs": [
		  ...
		  //       ],
            ...
            $('#ourDevices tbody').on('click', ' tr', function() {
              ...
              console.log('API row values : ', data[1] );
            })
		// function modal(){
